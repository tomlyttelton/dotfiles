...
resolutions=(
  ...
  "--output DP-1 --off --output DP-2 --off --output HDMI-1 --off --output DP-3 --off --output DP-3-8 --mode 2560x1440 --pos 1440x509 --rotate normal --output DP-3-1 --primary --mode 2560x1440 --pos 0x0 --rotate left"
)
